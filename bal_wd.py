...
class Appli(object):
  def __init__(self, master):
     ...
     self.heading= Label(self.top, text="Balance Withdraw", font="arial 18 bold", bg="white")
     ...
     self.dep= Button(self.bottom, text=" Withdraw ", font="arial 15 bold", width="52", command=dept)
